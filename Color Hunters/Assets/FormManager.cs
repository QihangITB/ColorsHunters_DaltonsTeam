...
public class FormManager : MonoBehaviour
{
    ...
    /// <summary>
    /// M�todo para manejar el inicio de sesi�n del usuario. 
    ...
    /// <summary>
    /// M�todo para redirigir al usuario a la pantalla de registro.
    ...
    /// Despu�s navega a la escena siguiente.
    /// </summary>
    ...
    /// <summary>
    /// M�todo para guardar los datos del cliente en el GameManager durante en el juego.
    /// </summary>
    ...
    /// <summary>
    /// A�ade la lista de nombres y apellidos de oftalm�logos de la base de datos al Dropdown del formulario de registro.
    /// </summary>
    /// <param name="options">Lista de nombres y apellidos de los oftalm�logos.</param>
